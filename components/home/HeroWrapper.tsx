        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Learn how to make the most of Req Jet with our detailed guides and
              examples
            </motion.p>
          </motion.div>
            ...
            >
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-4">
                    Complete reference for all endpoints, parameters, and
                    responses.
                  </p>
                  <Button
                    variant="outline"
              ...
              <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-8 border border-border">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6">
                    Join thousands of developers already using Req Jet for their
                    API testing needs.
                  </p>
                  <Button
                    size="lg"
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed max-w-md">
                The fastest way to test, debug, and document your APIs. Built
                for developers who demand speed and reliability.
              </p>
